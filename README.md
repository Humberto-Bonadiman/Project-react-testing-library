...
Nesse projeto eu escrevi testes para uma aplicação React, onde fui capaz de:
...
```javascript
  ...
  git clone git@github.com:Humberto-Bonadiman/Project-react-testing-library.git
```
...
4.Para verificar o funcionamento dos testes digite os seguntes comandos no terminal:
```javascript
  npm test
  a
```
